					...
					<div class="tabbable tabbable-custom tabbable-full-width">
						...
						<div class="tab-content">
							...
							<div class="tab-pane" id="tab_1_3">
								<?php
								$query_vacunas = "select enfermedad, lote, fecha_vacunacion
											   from vacunas
											   where id_mascota = ".$_GET['m'];
								$result_vacunas = mysqli_query($conn,$query_vacunas);
								while($row_vacunas = mysqli_fetch_array($result_vacunas)){
									?>
								<div class="row portfolio-block">
									<div class="col-md-6">
										<div class="portfolio-text">										
											<div class="portfolio-info">
												 Vacuna contra. <span>
												<?php echo $row_vacunas['enfermedad']; ?> </span>
											</div>
										</div>
									</div>
									<div class="col-md-6 portfolio-stat">
										<div class="portfolio-info">
											 Lote <span>
											<?php echo $row_vacunas['lote']; ?> </span>
										</div>
										<div class="portfolio-info">
											 Fecha de vacunación. <span>
											<?php echo $row_vacunas['fecha_vacunacion']; ?> </span>
										</div>									
									</div>
								</div>
								<?php
							...
							<div class="tab-pane" id="tab_1_4">
								<?php
								$query_desparacitacion = "select producto, fecha_desparacitacion, proxima_desparacitacion
											   from desparacitacion
											   where id_mascota = ".$_GET['m'];
								$result_desparacitacion = mysqli_query($conn,$query_desparacitacion);
								while($row_desparacitacion = mysqli_fetch_array($result_desparacitacion)){
									?>
								<div class="row portfolio-block">
									<div class="col-md-6">
										<div class="portfolio-text">										
											<div class="portfolio-info">
												 Producto. <span>
												<?php echo $row_desparacitacion['producto']; ?> </span>
											</div>
										</div>
									</div>
									<div class="col-md-6 portfolio-stat">
										<div class="portfolio-info">
											 Fecha de desparacitación. <span>
											<?php echo $row_desparacitacion['fecha_desparacitacion']; ?> </span>
										</div>
										<div class="portfolio-info">
											 Próxima desparacitación. <span>
											<?php echo $row_desparacitacion['proxima_desparacitacion']; ?> </span>
										</div>									
									</div>
								</div>
								<?php
							...
							<div class="tab-pane" id="tab_1_5">
								...
								<div class="portlet box red ">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-stethoscope"></i>Control de peso
										</div>
									</div>
									<div class="portlet-body">
							...
							<!-- CONSULTA 	-->				
												<?php
													$query = "select fecha_control_peso, peso_kg
															  from control_peso 
															  where id_mascota = ".$_GET['m'];
													$result = mysqli_query($conn,$query);
																	...
																	<div class="row info_medicamentos">
																		<div class="col-md-4">
																			<div class="form-group">
																				...
																				<select id="txtFrecuencia" class="form-control">
											...
											<div class="portlet-body form">
												<form id="cliente-form" action="#" class="horizontal-form">
													<div class="form-body">
														...
														<div class="form-body">
																<h3 class="form-section">Desparacitación.</h3>	
															<div id="div_info_desparacitacion">										<!-- BEGIN-->
																<div class="row info_desparacitacion">
																	<div class="col-md-6">
																		<div class="form-group">
																			<label class="control-label">Fecha de desparacitación<span class="required"> * </span></label>
																				
																					<input type="date" id="fechaDeDesparacitacion" name="fechaDeDesparacitacion" class="form-control" placeholder="AAAA/MM/DD">
																...
																<div class="row info_desparacitacion">	
																	<div class="col-md-6">
																		<div class="form-group">
																			<label class="control-label">Próxima desparacitación<span class="required"> * </span></label>
																				
																					<input type="date" id="proximaDesparacitacion" name="proximaDesparacitacion" class="form-control" placeholder="AAAA/MM/DD">
														...
														<div class="form-actions right">
																<button type="button" id="btnRegistrarDesparacitacion" class="btn blue"><i class="fa fa-check"></i> Guardar</button>
														</div>
													</div>
												</form>
															<!-- END FORM  CLIENTE-->													
				...
				<!--"tab_5"-->							
											<div id="tab_5" class="tab-pane">
												<div class="portlet box green">
													<div class="portlet-title">
														<div class="caption">
															<i class="fa fa-stethoscope"></i>Control 
														</div>
														<div class="tools">
															<a href="javascript:;" class="collapse">
															</a>
													...
													<form id="cliente-form" action="#" class="horizontal-form">
														...
														<div class="form-body">
																<h3 class="form-section">Peso.</h3>	
															<div id="div_info_peso">										<!-- BEGIN-->
																<div class="row">
																	<div class="col-md-6">
																		<div class="form-group">
																			<label class="control-label">Fecha de control<span class="required"> * </span></label>
																				
																					<input type="date" id="fechaDeControl" name="fechaDeControl" class="form-control" placeholder="AAAA/MM/DD">
															...
															<div class="form-actions right">
																<button type="button" id="btnRegistrarControlPeso" class="btn blue"><i class="fa fa-check"></i> Guardar</button>
															</div>
													</form>
													<!-- END FORM  CLIENTE-->
																	</div>
				...
				<!--"tab_6"-->							
											<div id="tab_6" class="tab-pane">
												<div class="portlet box purple">
													<div class="portlet-title">
														<div class="caption">
															<i class="fa fa-user-md"></i>Control 
														</div>
														<div class="tools">
															<a href="javascript:;" class="collapse">
															</a>
												...
												<div class="portlet-body form">
													<form id="cliente-form" action="#" class="horizontal-form">
														...
														<div class="form-body">
																<h3 class="form-section">Vacunas.</h3>	
															<div id="div_info_vacunas">										<!-- BEGIN-->
																<div class="row info_vacunas">
																	<div class="col-md-6">
																		<div class="form-group">
																			<label class="control-label">Enfermedad<span class="required"> * </span></label>
																			<div class="input-icon right">
																					<i class="fa"></i>
																					<input type="text" id="enfermedad" name="enfermedad" class="form-control" placeholder="Enfermedad">
																				</div>
																			<span class="help-block">
																			 </span>
																		</div>
																	...
																	<div class="row info_vacunas">
																		<div class="col-md-6">
																			<div class="form-group">
																				<label class="control-label">Fecha de vacunación<span class="required"> * </span></label>
																					
																						<input type="date" id="fechaDeVacunacion" name="fechaDeVacunacion" class="form-control" placeholder="AAAA/MM/DD">
															...
															<div class="form-actions right">
																<button type="button" id="btnRegistrarVacuna" class="btn blue"><i class="fa fa-check"></i> Guardar</button>
															</div>
													</form>
													<!-- END FORM  CLIENTE-->
															</div>
...
jQuery(document).ready(function() {       
   // initiate layout and plugins
	...
	var id_mascota = <?php echo $_GET['m']; ?>
	
	$('#btnRegistrarPatologiaMedicamentos').click(function(){
		$.ajax({
					type: "POST",
					url: 'php/wsRegistrarPatologiaMedicamentos.php',
					dataType: "json",
					data: {
						id_mascota: id_mascota,
						patologia: $('#patologia').val(),
						medicamento: $('#medicamento').val(),
						txtFrecuencia: $('#txtFrecuencia').val(),
						dosis: $('#dosis').val(),
						periodo: $('#periodo').val()
						}
					})
	...
	$('#btnRegistrarDesparacitacion').click(function(){
		$.ajax({
					type: "POST",
					url: 'php/wsRegistrarDesparacitacion.php',
					dataType: "json",
					data: {
						id_mascota: id_mascota,
						fecha: $('#fechaDeDesparacitacion').val(),
						producto: $('#producto').val(),
						proxima_fecha: $('#proximaDesparacitacion').val()
						}
					})
					.done(function(respuesta) {
						if(respuesta.codigo == 1){
	...
	$('#btnRegistrarControlPeso').click(function(){
		$.ajax({
					type: "POST",
					url: 'php/wsRegistrarControlPeso.php',
					dataType: "json",
					data: {
						id_mascota: id_mascota,
						fecha_control: $('#fechaDeControl').val(),
						peso_kg: $('#peso_kg').val()
						}
					})
					.done(function(respuesta) {
	...
	$('#btnRegistrarVacuna').click(function(){
		$.ajax({
					type: "POST",
					url: 'php/wsRegistrarVacuna.php',
					dataType: "json",
					data: {
						id_mascota: id_mascota,
						enfermedad: $('#enfermedad').val(),
						lote: $('#lote').val(),
						fecha_vacunacion: $('#fechaDeVacunacion').val()
						}
					})
					.done(function(respuesta) {
						if(respuesta.codigo == 1){
